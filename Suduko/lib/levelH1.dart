...
class SudokuGameLevelH1 extends StatefulWidget {
  const SudokuGameLevelH1({Key? key}) : super(key: key);

  @override
  _SudokuGameLevelH1State createState() => _SudokuGameLevelH1State();
}

class _SudokuGameLevelH1State extends State<SudokuGameLevelH1> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Sudoku Hard Level 1'),
        leading: IconButton(
