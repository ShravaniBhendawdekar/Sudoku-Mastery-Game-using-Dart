...
class SudokuGameLevelH3 extends StatefulWidget {
  const SudokuGameLevelH3({Key? key}) : super(key: key);

  @override
  _SudokuGameLevelH3State createState() => _SudokuGameLevelH3State();
}

class _SudokuGameLevelH3State extends State<SudokuGameLevelH3> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Sudoku Hard Level 3'),
        leading: IconButton(
