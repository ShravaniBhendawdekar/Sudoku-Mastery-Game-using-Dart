...
class SudokuGameLevelM3 extends StatefulWidget {
  const SudokuGameLevelM3({Key? key}) : super(key: key);

  @override
  _SudokuGameLevelM3State createState() => _SudokuGameLevelM3State();
}

class _SudokuGameLevelM3State extends State<SudokuGameLevelM3> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Sudoku Medium Level 3'),
        leading: IconButton(
