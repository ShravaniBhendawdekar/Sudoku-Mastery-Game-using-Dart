...
class SudokuGameLevelM2 extends StatefulWidget {
  const SudokuGameLevelM2({Key? key}) : super(key: key);

  @override
  _SudokuGameLevelM2State createState() => _SudokuGameLevelM2State();
}

class _SudokuGameLevelM2State extends State<SudokuGameLevelM2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Sudoku Medium Level 2'),
        leading: IconButton(
