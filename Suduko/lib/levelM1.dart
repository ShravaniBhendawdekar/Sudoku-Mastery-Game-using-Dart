...
class SudokuGameLevelM1 extends StatefulWidget {
  const SudokuGameLevelM1({Key? key}) : super(key: key);

  @override
  _SudokuGameLevelM1State createState() => _SudokuGameLevelM1State();
}

class _SudokuGameLevelM1State extends State<SudokuGameLevelM1> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Sudoku Medium Level 1'),
        leading: IconButton(
