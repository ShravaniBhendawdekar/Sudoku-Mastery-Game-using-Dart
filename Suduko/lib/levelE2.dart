...
class SudokuGameLevelE2 extends StatefulWidget {
  const SudokuGameLevelE2({Key? key}) : super(key: key);

  @override
  _SudokuGameLevelE2State createState() => _SudokuGameLevelE2State();
}

class _SudokuGameLevelE2State extends State<SudokuGameLevelE2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Sudoku Easy Level 2'),
        leading: IconButton(
