...
class SudokuGameLevelE1 extends StatefulWidget {
  const SudokuGameLevelE1({Key? key}) : super(key: key);

  @override
  _SudokuGameLevelE1State createState() => _SudokuGameLevelE1State();
}

class _SudokuGameLevelE1State extends State<SudokuGameLevelE1> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Sudoku Easy Level 1'),
        leading: IconButton(
